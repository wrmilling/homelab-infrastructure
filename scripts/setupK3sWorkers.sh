...
qm clone 1000 401 --name k3s-amd64-a.homelab.tokyo --format raw --full --storage local-lvm
...
qm clone 1000 402 --name k3s-amd64-b.homelab.tokyo --format raw --full --storage local-lvm
...
qm clone 1000 403 --name k3s-amd64-c.homelab.tokyo --format raw --full --storage local-lvm
